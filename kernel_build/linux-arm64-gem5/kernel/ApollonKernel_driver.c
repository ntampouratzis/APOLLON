...
int ramdevice_init(void)
{
    ...
    PtolemySensorAttr = dma_alloc_coherent(dev_ret, sizeof(PtolemySensorAttr_t), &bus_addr_sensor_to_device, GFP_KERNEL);
    ...
    PtolemySensorData = dma_alloc_coherent(dev_ret, sizeof(PtolemySensorData_t), &bus_addr_sensor_from_device, GFP_KERNEL);
    ...
    PtolemyActuator = dma_alloc_coherent(dev_ret, sizeof(PtolemyActuator_t), &bus_addr_actuator_to_device, GFP_KERNEL);
...
void ramdevice_cleanup(void)
{
    ...
    dma_free_coherent(dev_ret, sizeof(PtolemySensorAttr_t), PtolemySensorAttr, bus_addr_sensor_to_device);
    dma_free_coherent(dev_ret, sizeof(PtolemySensorData_t), PtolemySensorData, bus_addr_sensor_from_device);
    dma_free_coherent(dev_ret, sizeof(PtolemyActuator_t), PtolemyActuator, bus_addr_actuator_to_device);
